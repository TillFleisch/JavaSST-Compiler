...
public class ProcedureTranslator {
     ...
     */
    private int maxStack = 0xFFFF;

    public ProcedureTranslator(ConstantPool constantPool, Objekt.Procedure procedure) throws IOException {
     ...
     */
    private byte[] toByteCode(Node node) throws IOException {
     ...
     */
    private byte[] toByteCode(Node.ProcedureCallNode procedureCallNode) throws IOException {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
     ...
     * </p>
     */
    private byte[] toByteCode(Node.WhileNode whileNode) throws IOException {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
     ...
     * </p>
     */
    private byte[] toByteCode(Node.IfNode ifNode) throws IOException {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
     ...
     */
    private byte[] toByteCode(Node.BinaryOperationNode binaryOperationNode) throws IOException {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
     ...
     * @return ByteCode representing the procedureCall node and subsequent nodes
     */
    private byte[] toByteCode(Node.IdentifierNode identifierNode) {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
